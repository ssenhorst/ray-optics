...
export const ParamMirror = require('./sceneObjs/mirror/ParamMirror.js').default;
export const CurveMirror = require('./sceneObjs/mirror/CurveMirror.js').default;
...
export const CustomSurface = require('./sceneObjs/other/CustomSurface.js').default;
...
export const WaveLineSource = require('./sceneObjs/wave/WaveLineSource.js').default;
export const WavePlaneWave = require('./sceneObjs/wave/WavePlaneWave.js').default;
export const WaveInterface = require('./sceneObjs/wave/WaveInterface.js').default;
export const WaveSquareGrating = require('./sceneObjs/wave/WaveSquareGrating.js').default;
export const WaveSinusoidalGrating = require('./sceneObjs/wave/WaveSinusoidalGrating.js').default;
export const WaveBinaryMask = require('./sceneObjs/wave/WaveBinaryMask.js').default;
export const WaveMultiSlit = require('./sceneObjs/wave/WaveMultiSlit.js').default;
export const WaveZonePlate = require('./sceneObjs/wave/WaveZonePlate.js').default;
