        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="fileDropdown">
            ...
            <li><button
              ...
              type="button"
              id="import_shapes"
              @click="handleImportShapes"
              v-tooltip-popover:[tooltipType]="layout === 'desktop' ? {
                content: $t('simulator:file.importShapes.description'),
                placement: 'right'
              } : undefined"
              v-text="$t('simulator:file.importShapes.title')"
            ></button></li>
...
export default {
  ...
  methods: {
    ...
    handleImportShapes(event) {
      event.target.blur();
      app.startImportShapes();
    },
